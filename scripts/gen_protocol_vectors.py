...
def build(object_type):
    ...
    if object_type == "task_spec":
        ...
        cases = [
            ...
            ("pos-policy-refs-a", True, "CT-03：policyTemplateRefs 两元素（key 序）",
             {"policyTemplateRefs": [{"templateRef": "eval-tpl/001", "templateDigest": D64},
                                     {"templateRef": "eval-tpl/002", "templateDigest": D64}]}, None),
            ("pos-policy-refs-b", True, "CT-03：同一集合乱序——digest 与 pos-policy-refs-a 一致",
             {"policyTemplateRefs": [{"templateRef": "eval-tpl/002", "templateDigest": D64},
                                     {"templateRef": "eval-tpl/001", "templateDigest": D64}]}, None),
